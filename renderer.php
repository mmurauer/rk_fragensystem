 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_rk_fragesystem_renderer extends plugin_renderer_base {
    /**
    ...
    public function review_form($page, $showall, $displayoptions, $content, $attemptobj) {
        ...
        $this->page->requires->js_init_call('M.block_rk_fragesystem.init_review_form', null, false,
                quiz_get_js_module());
    ...
    public function finish_review_link(quiz_attempt $attemptobj) {
        ...
        if ($attemptobj->get_access_manager(time())->attempt_must_be_in_popup()) {
            $this->page->requires->js_init_call('M.block_rk_fragesystem.secure_window.init_close_button',
    ...
    public function navigation_panel(quiz_nav_panel_base $panel) {
        ...
        $this->page->requires->js_init_call('M.block_rk_fragesystem.nav.init', null, false,
                quiz_get_js_module());
     ...
     *
     * @param block_rk_fragesystem_links_to_other_attempts $links
     */
    protected function render_block_rk_fragesystem_links_to_other_attempts(
            block_rk_fragesystem_links_to_other_attempts $links) {
        $attemptlinks = array();
    ...
    public function attempt_form($attemptobj, $page, $slots, $id, $nextpage) {
        ...
        $output .= html_writer::start_tag('form',
                array('action' => new moodle_url("processattempt.php"), 'method' => 'post',
    ...
    public function initialise_timer($timerstartvalue, $ispreview) {
        ...
        $this->page->requires->js_init_call('M.block_rk_fragesystem.timer.init', $options, false, quiz_get_js_module());
    }
    ...
    public function close_attempt_popup($url, $message = '') {
        ...
        $this->page->requires->js_init_call('M.block_rk_fragesystem.secure_window.close',
     ...
     *
     * @param quiz_attempt $attemptobj
     * @param block_rk_fragesystem_display_options $displayoptions
     */
     ...
     * @param block_rk_fragesystem_view_object $viewobj
     ...
     * @param block_rk_fragesystem_view_object $viewobj the information required to display
     * the view page.
     * @return string HTML to output.
     */
    public function view_page_buttons(block_rk_fragesystem_view_object $viewobj) {
        $output = '';
    ...
    public function start_attempt_button($buttontext, moodle_url $url,
        ...
        if ($popuprequired) {
            ...
            $button->add_action(new component_action('click',
                    'M.block_rk_fragesystem.secure_window.start_attempt_action', array(
                        'url' => $url->out(false),
...
class block_rk_fragesystem_links_to_other_attempts implements renderable {
    /**
...
class block_rk_fragesystem_view_object {
