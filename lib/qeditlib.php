...
class question_bank_view {
    ...
    public function display($tabname, $page, $perpage, $cat,
            $recurse, $showhidden, $showquestiontext, $myquestions = false) {
        global $PAGE, $OUTPUT;
        ...
        $this->display_question_list($this->contexts->having_one_edit_tab_cap($tabname),
                ...
                $this->contexts->having_cap('moodle/question:add'), $myquestions);
    }
    ...
    protected function create_new_question_form($category, $canadd, $myquestions = false) {
        global $CFG;
        
        echo '<div class="createnewquestion">';
        if ($canadd) {
            create_new_question_button($category->id, $this->editquestionurl->params(),
                    get_string('createnewquestion', 'question'), null, false, $myquestions);
        } else {
    ...
    */
    protected function display_question_list($contexts, $pageurl, $categoryandcontext,
            ...
            $showquestiontext = false, $addcontexts = array(), $myquestions = false) {
        ...
        $this->create_new_question_form($category, $canadd, $myquestions);
        ...
        $rowcount = 0;
        foreach ($questions as $question) {
        	if(($question->createdby == $USER->id && $myquestions) || !$myquestions) {
 ...
 */
function create_new_question_button($categoryid, $params, $caption, $tooltip = '', $disabled = false, $myquestions = false) {
    global $CFG, $PAGE, $OUTPUT;
    ...
    if (!$choiceformprinted) {
        ...
        $types = array();
        if($myquestions) 
        	$types = array('multichoice','truefalse','shortanswer');
        
        print_choose_qtype_to_add_form(array(),$types,$myquestions);
        echo "</div>\n";
