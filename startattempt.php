...
require_login($quizobj->get_course(), false);
...
if ($currentattemptid) {
    ...
    redirect(new moodle_url("attempt.php",array("attempt"=>$currentattemptid)));
}
...
redirect(new moodle_url("attempt.php",array("attempt"=>$attempt->id)));
